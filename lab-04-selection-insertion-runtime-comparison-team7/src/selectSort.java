...
class SelectSortApp {
    ...
    protected long sortLargeRandomArray() {
        ...
        arr = new ArraySel(numElements);

        insertRandomData(numElements);

        // use insertRandomData method to create ArraySel instance with 100,000

        long startTime = System.currentTimeMillis();
        long numSwaps = arr.selectionSort();
    ...
    public static void main(String[] args) {
        SelectSortApp app = new SelectSortApp();
